...
import { EventEmitter, Component, Input, Output, NgModule, Inject, ViewChild } from '@angular/core';
...
class NgxHisbCommonUiModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.9", ngImport: i0, type: NgxHisbCommonUiModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.2.9", ngImport: i0, type: NgxHisbCommonUiModule, declarations: [CommonErrorComponent], imports: [MatIconModule,
            MatToolbarModule,
            RouterLink,
            MatDividerModule,
            NgIf,
            BrowserAnimationsModule,
            MatButtonModule], exports: [CommonErrorComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.2.9", ngImport: i0, type: NgxHisbCommonUiModule, imports: [MatIconModule,
            MatToolbarModule,
            MatDividerModule,
            BrowserAnimationsModule,
            MatButtonModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.9", ngImport: i0, type: NgxHisbCommonUiModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
