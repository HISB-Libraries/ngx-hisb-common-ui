...
class NgxHisbCommonUiModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.7", ngImport: i0, type: NgxHisbCommonUiModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.2.7", ngImport: i0, type: NgxHisbCommonUiModule, imports: [MatIconModule,
            MatToolbarModule,
            RouterLink,
            MatDividerModule,
            NgIf,
            BrowserAnimationsModule] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.2.7", ngImport: i0, type: NgxHisbCommonUiModule, imports: [MatIconModule,
            MatToolbarModule,
            MatDividerModule,
            BrowserAnimationsModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.7", ngImport: i0, type: NgxHisbCommonUiModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [],
                    imports: [
...
export { ConformationDialogComponent, HeaderComponent, JsonValidator, NavMenuComponent, NgxHisbCommonUiModule, ResourceTypeValidator, TextInputDialogComponent, openConfirmationDialog, openTextInputDialog };
